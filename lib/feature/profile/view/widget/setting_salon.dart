      ...
      child: Container(
        ...
        child: Column(
            ...
            children: [
              ...
              // ListTile(
              //   leading: Icon(FontAwesome.lock_solid, color: Colors.blue.shade400,),
              //   title: Text('Privacy'),
              //   subtitle: Text('user data'),
              // ),
              // const SizedBox(height: 10,), 
              // ListTile(
              //   leading: Icon(FontAwesome.person_falling_solid, color: Colors.blue.shade400,),
              //   title: Text('Appointment'),
              //   subtitle: Text('Remeinder, Communication'),
              // ), 
              // const SizedBox(height: 10,), 
              // ListTile(
              //   leading: Icon(FontAwesome.shield_solid, color: Colors.blue.shade400,),
              //   title: Text('Security'),
              //   subtitle: Text('Two-factor authentication, Change password'),
              // ), 
              // ListTile(
              //   leading: Icon(FontAwesome.money_bill_solid, color: Colors.blue.shade400,),
              //   title: Text('Payments'),
              //   subtitle: Text('default payment, Add/manage payments'),
              // ), 
              // const SizedBox(height: 10,), 
              // ListTile(
              //   leading: Icon(FontAwesome.circle_check_solid, color: Colors.blue.shade400,),
              //   title: Text('Storage and Data'),
              //   subtitle: Text('Network usage, Storage'),
              // ), 
              // const SizedBox(height: 10,), 
              // ListTile(
              //   leading: Icon(FontAwesome.bell_solid, color: Colors.blue.shade400,),
              //   title: Text('Notification'),
              //   subtitle: Text('Notification preferences'),
              // ), 
              // const SizedBox(height: 10,), 
              // ListTile(
              //   leading: Icon(FontAwesome.key_solid, color: Colors.blue.shade400,),
              //   title: Text('Account'),
              //   subtitle: Text('Delete, Manage contents'),
              // ), 
              // const SizedBox(height: 10,), 
              // ListTile(
              //   leading: Icon(FontAwesome.earth_africa_solid, color: Colors.blue.shade400,),
              //   title: Text('Language'),
