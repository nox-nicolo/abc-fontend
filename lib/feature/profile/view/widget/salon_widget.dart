...
class SalonCustomWidget extends ConsumerStatefulWidget {
  const SalonCustomWidget({super.key});

  @override
  ConsumerState<SalonCustomWidget> createState() => _SalonCustomWidgetState();
}

class _SalonCustomWidgetState extends ConsumerState<SalonCustomWidget>
